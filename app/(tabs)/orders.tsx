...
export default function OrdersScreen() {
  ...
  const moveMutation = useMutation({
    ...
    onError: (_err, _vars, ctx) => {
      if (ctx?.previous)
        queryClient.setQueryData(["orders-board"], ctx.previous);
    },
    onSettled: () => {
        ...
        <Button
          ...
          onPress={() =>
            queryClient.invalidateQueries({
              queryKey: [
                topTab === "active" ? "orders-board" : "orders-history",
              ],
            })
          }
          size="md"
...
function TopTabButton({
  ...
  return (
    ...
    >
      <Text
        style={[styles.topTabBtnText, active && styles.topTabBtnTextActive]}
      >
        {label}
      </Text>
    </Pressable>
  ...
  return (
    ...
    >
      <View style={[styles.columnHeader, { borderBottomColor: tone.border }]}>
        ...
        <Text style={[styles.columnLabel, { color: tone.accent }]}>
          {label}
        </Text>
